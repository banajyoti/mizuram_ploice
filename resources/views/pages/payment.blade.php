...
<div class="px-4 grow flex flex-col">
	...
	<div class="p-4 grow border border-gray-300 rounded-lg flex">
		<div class="m-auto text-center space-y-3">
			...
			<p class="md:text-md text-green-600 font-medium">Proceede to pay as per the post.</p>
			<p class="text-sm">Post's</p>
			<div class="flex flex-wrap items-center justify-center gap-3">
				<span class="inlone-block p-2 px-4 w-full md:w-auto border rounded-xl border-blue-600"><i class="bi bi-1-circle text-blue-800 pr-2"></i>AB (ARMED BRANCH)</span>
				<span class="inlone-block p-2 px-4 w-full md:w-auto border rounded-xl border-blue-600"><i class="bi bi-2-circle text-blue-800 pr-2"></i>UB (UNARMED BRANCH)</span>
				<span class="inlone-block p-2 px-4 w-full md:w-auto border rounded-xl border-blue-600"><i class="bi bi-3-circle text-blue-800 pr-2"></i>CONSTABLE</span>
			</div>
...
<div class="mt-auto px-4 flex items-center">
	<a class="inline-block bg-gray-600 hover:bg-gray-700 text-white p-2 rounded-md Nunito" href="{{ route('document') }}"><i class="bi bi-arrow-left-short pr-1"></i>Go Back</a>
	<a class="ml-auto inline-block bg-green-600 hover:bg-green-700 text-white p-2 rounded-md Nunito" href="download.php"><i class="bi bi-check-all pr-1"></i>proceed</a>
</div>
